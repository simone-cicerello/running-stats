...
public class DummyController {
  ...
  public ResponseEntity<Serializable> echo(
      HttpServletRequest httpServletRequest, @RequestBody(required = false) Serializable rb) {
    ...
    if (Objects.nonNull(rb)) return new ResponseEntity<>(rb, HttpStatus.OK);
